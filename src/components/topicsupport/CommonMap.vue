  ...
  <div class="chart-bg">
    ...
    <div class="view-type">
      ...
      >
        ...
        >
        <span>
          {{ item.name }} <span>{{ data.info[item.column] }}</span>
        </span>
      </div>
    </div>
    <div
...
export default {
  ...
  setup (props, context) {
    ...
    const getLegendList = () => {
      ...
      const list = [
        { label: `0 - ${Math.ceil(maxValue * 0.25)}`, min: 0, max: Math.ceil(maxValue * 0.25), color: '#dcf3f9' },
        { label: `${Math.ceil(maxValue * 0.25) + 1} - ${Math.ceil(maxValue * 0.5)}`, min: Math.ceil(maxValue * 0.25), max: Math.ceil(maxValue * 0.5), color: '#D9E9FF' },
        { label: `${Math.ceil(maxValue * 0.5) + 1} - ${Math.ceil(maxValue * 0.75)}`, min: Math.ceil(maxValue * 0.5), max: Math.ceil(maxValue * 0.75), color: '#E9FFE9' },
        { label: `${Math.ceil(maxValue * 0.75) + 1} - ${maxValue}`, min: Math.ceil(maxValue * 0.75), max: maxValue, color: '#FFF5E1' },
      ]
