<template>
  <div style="width: 100%;height: 40px;">
    <ul class="marquee-list">
      <li>
        <p style="color: #000000">排名</p>
        <span style="color: #000000">区域</span>
        <em style="color: #000000"> 影响切片</em>
        <p style="color: #000000;margin-left: 120px;">工单数</p>
        <span style="color: #000000;margin-left: 100px;">影响客户</span>
      </li>
    </ul>
    <div
      class="marquee-warp"
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style="margin-left: 35px;color: #000000">{{item.title}}</span>
