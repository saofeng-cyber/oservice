      ...
      <div class="null-warn">
        <div class="warn-left">
          ...
          <div class="warn-div">
            ...
            <span class="sapn-box" style="margin-left: 10px">
              <el-progress
                class="warn-progress"
                style="
                  width: 160px;
          ...
          <div class="warn-div">
            ...
            <span class="sapn-box1" style="margin-left: 10px">
              <el-progress
                class="warn-progress"
                style="
                  width: 160px;
          ...
          <div class="warn-div">
            ...
            <span class="sapn-box2" style="margin-left: 10px">
              <el-progress
                class="warn-progress"
                style="
                  width: 160px;
          ...
          <div class="warn-div">
            ...
            <span class="sapn-box3" style="margin-left: 10px">
              <el-progress
                class="warn-progress"
                style="
                  width: 160px;
        ...
        <div class="warn-right">
          ...
          <div class="warn-div">
            ...
            <span class="sapn-box4" style="margin-left: 10px">
              <el-progress
                class="warn-progress"
                style="
                  width: 160px;
