...
export default {
  ...
  setup() {
    ...
    let data = ref([
      {
        yname: "拨测告警",
        xname: ["10:00", "10:30", "11:00", "11:30", "12:00", "12:30"],
        ynum: [30, 40, 50, 60, 40, 40],
      },
      {
        yname: "业务告警",
        xname: ["10:00", "10:30", "11:00", "11:30", "12:00", "12:30"],
        ...
        itemStyle: {
          color: {
            ...
            colorStops: [
              {
                offset: 0,
                color: val[0].colorb, // 0% 处的颜色
              },
              {
                offset: 1,
                color: val[0].colort, // 100% 处的颜色
              },
            ],
        ...
        itemStyle: {
          color: {
            ...
            colorStops: [
              {
                offset: 0,
                color: val[1].colorb, // 0% 处的颜色
              },
              {
                offset: 1,
                color: val[1].colort, // 100% 处的颜色
              },
            ],
            global: false, // 缺省为 false
          },
        ...
        itemStyle: {
          color: {
            ...
            colorStops: [
              {
                offset: 0,
                color: val[2].colorb, // 0% 处的颜色
              },
              {
                offset: 1,
                color: val[2].colort, // 100% 处的颜色
              },
            ],
            global: false, // 缺省为 false
          },
...
.top-title {
  ...
  height: 40px;
  border-bottom: 1px solid #66e2fb;
}
.float-title {
  font-weight: 500;
  line-height: 24px;
