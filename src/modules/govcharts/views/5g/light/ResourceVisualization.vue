...
import NetResource from '@/components/topicsupport/NetResourceLight.vue'
...
export default {
  components: {
    Map, MapTopCard, RingChart, NetResource, MapHeader, WarnRanking, LineChart, SearchInfo
  },
  setup () {
    const $axios = inject('$axios')
    let sysConfig = {};
    const queryDataUrl = '/ser-ge-main/api/v1/tgedpdatacontroller/getFgResourceData';
    const queryDataUrl2 = '/ser-ge-main/api/v1/tgedpdatacontroller/getFgResourceData2';
    const queryTopDataUrl = '/ser-ge-main/api/v1/tgedpdatacontroller/getFgResourceTopData';
    ...
    let mapTopCardList = ref([
      { "key": "0", "name": "5G专网客户数", "value": 12493, "img": "CIcon-Avatar", "color": "rgba(46, 196, 120, 1)", "backgroundColor": "linear-gradient(360deg, rgba(46, 196, 120, 0.64) 0%, rgba(46, 196, 120, 0.32) 100%)" },
      { "key": "1", "name": "专用DNN数", "value": 867, "img": "CIcon-Sound-One", "color": "rgba(17, 174, 220, 1)", "backgroundColor": "linear-gradient(360deg, rgba(17, 174, 220, 0.64) 0%, rgba(17, 174, 220, 0.32) 100%)" },
      { "key": "2", "name": "专用切片数", "value": 563, "img": "CIcon-Card-Two", "color": "rgba(255, 170, 6, 1)", "backgroundColor": "linear-gradient(360deg, rgba(255, 170, 6, 0.64) 0%, rgba(255, 170, 6, 0.32) 100%)" },
      { "key": "3", "name": "专用开卡数", "value": 867324, "img": "CIcon-Sim-Card", "color": "rgba(2, 106, 255, 1)", "backgroundColor": "linear-gradient(360deg, rgba(2, 106, 255, 0.64) 0%, rgba(2, 106, 255, 0.32) 100%)" }
    ]);
    ...
    const queryData = function () {
      ...
      $axios.post(url, {
        ...
        coreNetRes5G.value.setValues([
          { "name": "共享型UPF数", "value": (res.data.SHARED_UPF_COUNT || 0), "img": "UPF.png" },
          { "name": "独享型UPF数", "value": (res.data.UNSHARED_UPF_COUNT || 0), "img": "UPF.png" },
        ...
        honorNetRes5G.value.setValues([
          { "name": "独享型无线基站数", "value": (res.data.SITE_COUNT || 0), "img": "BaseStation.png" },
          { "name": "独享型MEC资源数", "value": (res.data.MEC_COUNT || 0), "img": "MEC.png" }
        ])

        const val1 = {
          "title": "客户服务模式",
          "info": [
            { "value": (res.data.YOUXIANG_COUNT || 0), "name": "优享", "color": "#0066FF", "url": "" },
            { "value": (res.data.ZHUANXIANG_COUNT || 0), "name": "专享", "color": "#FFA800", "url": "" },
            { "value": (res.data.ZUNXIANG_COUNT || 0), "name": "尊享", "color": "#2EC478", "url": "" }
          ]
        }
        ...
        const val2 = {
          "title": "DNN类型",
          "info": [
            { "value": (res.data.NATIONAL_DNN_COUNT || 0), "name": "全国", "color": "#2EC478", "url": "" },
            { "value": (res.data.PROVINCE_DNN_COUNT || 0), "name": "省内", "color": "#0066FF", "url": "" }
          ]
        }
    ...
    return {
      ...
      dnnRingChart, handleMapChange, warnRanking1, warnRanking2, warnRanking3, lineChartTitle, lineChart, mapChart, handleBack, isProvinceSelect,
      handleResChange, searchShow, dialogVisible, dialogVisibleTow, searchInfo,
      currentPage, totalSize, handleSizeChange, handleCurrentChange, conditions, tableDatas, customerClick, globalStyle
    }
  }
}
</script>
