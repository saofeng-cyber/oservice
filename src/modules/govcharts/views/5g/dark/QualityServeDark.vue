<template>
  <div class="page-wrapper" :style="globalStyle">
      ...
      <el-col :span="10" style="height: 100%">
        <div class="card-right card-1">
          ...
          <div style="padding: 5px 10px">
            <el-row :gutter="20">
              <el-col :span="8">
                <div style="border: 1px solid #66e2fb">
        ...
        <div class="card-right border-inner card-2">
          <div class="float-title">
            <span class="i"></span>
            接入指标分析
            <i
        ...
        <div class="card-right border-inner card-3">
          <div class="float-title">
            <span class="i"></span>
            业务质量分析
            <i
        ...
        <div class="card-right border-inner card-4">
          <div class="float-title">
            <span class="i"></span>
            拨测质量分析
            <i
    ...
    <div class="row-2 border-inner card-bottom">
      <div class="float-title">
        <span class="i"></span>
        质量趋势
      </div>
