      ...
      <el-col :span="6">
        <div class="card-left card-1">
          ...
          <div
            ...
            style="background-color: rgb(0, 0, 0, 0.32)"
          >
            <div
        ...
        >
          ...
          <div class="map-top" style="float: right">
            <div style="z-index: 99">
              <el-radio-group v-model="radio2" size="small" fill="#113453">
                <el-radio-button
                  label="全部"
      ...
      <el-col :span="6">
        ...
        <div class="card-right card-2">
          ...
          <EffectWarningFgOverview
            style="width: 120%; height: calc(100% - 40px)"
        ...
        <div class="card-right card-3">
          <div class="float-title">
            ...
            <span
              class="pointer"
              style="color: #fff"
              @click="gongdanXingqing('满意度')"
              >满意度</span
            >
            <i class="el-icon-setting" style="float: right;color:#fff"></i>
          </div>
          <BusiSatis
            :style="{
              backgroundImage:
...
import LineChart from "@/components/common/LineChartDarkFg.vue";
// import MapTopCard from "@/components/common/MapTopCardLightFg";
import WarnRanking from "@/components/emergency/WarnRankingDarkFg";
import TableDialog from "@/components/common/TableDialogLightFg";
import { provide } from "vue";
import MapHeader from "@/components/common/MapHeaderLightFg";
import BusiSatis from "@/components/topicsupport/BusiSatis";
import EffectWarningFgOverview from "@/components/qualityservice/EffectWarningFgOverview";
import RingPieChart from "@/components/common/RingPieChartFgDark.vue";
import RingChart from "@/components/common/CircleProgressBarFgDark";
