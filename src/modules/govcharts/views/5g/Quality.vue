    ...
    <el-row class="row-1" :gutter="15">
      ...
      <el-col :span="10">
        ...
        <div class="card-right card-with-title card-2">
          <GaugeColored3 ref="accessQuotaRef" @self-refresh="accessQuotaRefresh"></GaugeColored3>
        </div>
...
<script>
  ...
  import GaugeColored3 from '@/components/common/GaugeColored3.vue';
    ...
    setup() {
      ...
      function handleMapChange(val) {
        ...
        $axios.post(url, {
          "desc": "质量可视化",
          "spe": "5g",
          "jsonFile": "quality_and_visualization_rate_yunnan.json"
        }).then(res => accessQuotaRef.value.setValues(res))
        // --TODO:  业务质量-拨测业务指标 --
        $axios.post(url, {
          "desc": "质量可视化",
          "spe": "5g",
          "jsonFile": "quality_and_visualization_indicator_yunnan.json"
        }).then(res => refPullOut.value.setValue(res))
        // --TODO: 网络质量-影响业务告警--
      ...
      const handleBack = () => { // 返回全国视图
        ...
        $axios.post(url, {
          "desc": "质量可视化",
          "spe": "5g",
          "jsonFile": "quality_and_visualization_rate.json"
        }).then(res => accessQuotaRef.value.setValues(res))
        // --TODO:  业务质量-拨测业务指标 --
        $axios.post(url, {
          "desc": "质量可视化",
          "spe": "5g",
          "jsonFile": "quality_and_visualization_indicator.json"
        }).then(res => refPullOut.value.setValue(res))
        // --TODO: 网络质量-影响业务告警--
        $axios.post(url, {
          "desc": "质量可视化",
          "spe": "5g",
          "jsonFile": "quality_and_visualization_network.json"
        }).then(res => refEffectWarning.value.setValue(res))
        // --TODO 省排名 云南数据 --
