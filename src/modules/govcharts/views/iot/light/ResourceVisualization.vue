...
export default {
  components: {
    Map, MapTopCard, RingChart, MapHeader, WarnRanking, LineChart, SearchInfo, Warn, TableDialog, QueryCondition, BusSta, TradeDis
  },
  setup () {
    ...
    return {
      ...
      handleResChange, showLeftMenu, leftMenus, openLeftMenu, searchShow, getCondition, getTableMessage, dialogVisible, dialogVisibleTow, busSta, tradeDis
    }
  }
}
</script>
