    ...
    <el-row class="row-1" :gutter="15">
      ...
      <el-col :span="10">
        ...
        <div style="margin-bottom: 15px;">
          <img src="../../../../assets/resource/bBroad1.png" style="margin: -6px;" alt="">
        </div>
        <div style="margin-bottom: 15px;">
          <img src="../../../../assets/resource/bBroad2.png" style="margin: -6px;" alt="">
        </div>
        <div>
          <img src="../../../../assets/resource/bBroad3.png" style="margin: -6px; height: 215px; width: 100%;" alt="">
        </div>
