    ...
    <el-row class="row-1" :gutter="15">
      <el-col :span="14">
        <div class="card-left card-4-angle">
          ...
          <div class="button-img">
            <img src="../../../../assets/resource/cNetHeader-img.png" alt="">
          </div>
          <div class="map-top">
            <el-row :gutter="12">
      ...
      <el-col :span="10">
        ...
        <div style="margin-bottom: 15px;">
          <img src="../../../../assets/resource/cNet2.png" style="margin: -6px;" alt="">
        </div>
        <div>
          <img src="../../../../assets/resource/cNet1.png" style="margin: -6px;" alt="">
        </div>
...
<script>
  ...
  export default {
    components: {
      Map, MapTopCard, RingChart, MapHeader, WarnRanking, LineChart, SearchInfo, Warn, TableDialog, QueryCondition, Rotate
    },
    setup() {
