    ...
    <el-row class="row-1" :gutter="15">
      ...
      <el-col :span="10">
        ...
        <div class="card-right card-with-title card-2">
          <img src="../../../../assets/resource/cNet/net-business.png" style="width: 100%; height: 100%;">
        </div>
        <div class="card-right card-with-title card-3">
          <img src="../../../../assets/resource/cNet/net-device.png" style="width: 100%; height: 100%;">
        </div>
        <div class="card-right card-with-title card-4">
          <img src="../../../../assets/resource/cNet/alarmStatistics.png" style="width: 100%; height: 100%;">
        </div>
      </el-col>
    </el-row>
    <el-row class="row-2" :gutter="15">
      <el-col :span="12">
        <div class="card-bottom card-with-title card-1">
          <img src="../../../../assets/resource/cNet/order-rate.png" style="width: 100%; height: 100%;">
        </div>
      </el-col>
      <el-col :span="12">
        <div class="card-bottom card-with-title card-3">
          <img src="../../../../assets/resource/cNet/res-pool.png" style="width: 100%; height: 100%;">
        </div>
      </el-col>
    </el-row>
    <!-- 弹框组件 -->
