  ...
  <div class="page-wrapper">
    <el-row class="row-1" :gutter="15">
      ...
      <el-col :span="10">
        ...
        <div class="card-right card-2" style="margin-left:-7px;margin-right:-7px;">
          <img src="@/assets/quality/slaquality.png" style="width: 100%;height: 100%" />
        </div>
        <div class="card-right card-3" style="margin-left:-4px;margin-right:-4px;">
          <img src="@/assets/quality/netquality.png" style="width: 100%;height: 100%" />
        </div>
        <div class="card-right card-with-title card-4">
          <NetResource ref="sCameraResource" @handleResChange="handleSCameraResChange" />
        </div>
      </el-col>
    </el-row>
    ...
    <el-row class="row-2" :gutter="15">
      <el-col :span="12">
        ...
        <div class="leftcard">
          <div class="card-bottom card-with-title card-1">
            <WarnRanking1 ref="refWarn_1" :title="'客户总数分省排名'"></WarnRanking1>
          </div>
          <div class="card-bottom card-with-title card-1">
            <WarnRanking1 ref="refWarn_2" :title="'客户总数分省排名'"></WarnRanking1>
          </div>
        </div>
      </el-col>
      <el-col :span="12">
