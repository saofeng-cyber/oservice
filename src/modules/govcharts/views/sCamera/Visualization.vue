<template>
  <div class="page-wrapper">
          ...
          <div class="card-right card-with-title card-2">
            ...
            <div style="height: 90px">
              <div class="float-titles">
                <i class="el-icon-caret-right" style="margin-left: -215px"></i>
                <p>集团工单总数</p>
                <NumberWrap :endVal="0"></NumberWrap>
              ...
              <div style="padding-top: 40px">
                <div style="
                  ...
                  <div style="
                      ...
                      padding: 0 5px;
                    ">
                    <span style="color: #fff; font-size: 12px">处理及时率</span>
                    <span style="color: #0eacdb; font-size: 12px">92.00%</span>
                  </div>
                  <div style="display: flex">
                    <div style="
                        width: 15px;
                        height: 15px;
                        background-color: #21dde6;
                        margin-left: 5px;
                      "></div>
                    <div style="
                        width: 15px;
    ...
    font-size: 12px">超时</span>
        ...
        <el-col :span="6">
          <div class="card-right card-with-title card-2" style="margin-left: 195px">
            <!-- 集团工单数右边 -->
            <div style="height: 90px">
              <div class="float-titles">
                <i class="el-icon-caret-right" style="margin-left: -225px"></i>
                <p style="margin-left: 400px">省内工单数总数</p>
                <NumberWrap :endVal="0"></NumberWrap>
                <NumberWrap :endVal="4"></NumberWrap>
                <NumberWrap :endVal="0"></NumberWrap>
                <NumberWrap :endVal="3"></NumberWrap>
              </div>
              <div style="padding-top: 40px">
                <div style="
                  ...
                  <div style="
                    ...
                    ">
                    <span style="color: #fff; font-size: 12px">处理及时率</span>
                    <span style="color: #2dc477; font-size: 12px">92.00%</span>
                  </div>
                  <div style="display: flex">
                    <div style="
                        width: 15px;
                        height: 15px;
                        background-color: #2dc477;
                        margin-left: 5px;
                      "></div>
                    <div style="
                        width: 15px;
            ...
            <RingChart style="height: 160px" ref="ringchart2"></RingChart>
            <div>
              <div style="    width: 15px;
    height: 15px;
    background-color: #6DF3FD;
    ...
    font-size: 12px">超时</span>
        ...
        <div class="card-right card-with-title card-3">
            ...
            <div class="float-title-right">
              <div class="case-distribution-line">
                ...
                <div class="case-distribution-two">
                  <p style="margin-top: 4px">优享</p>
                </div>
                <div class="case-distribution-three">
                  <p style="margin-top: 4px">专享</p>
                </div>
                <div class="case-distribution-fore">
                  <p style="margin-top: -5px">尊享</p>
                </div>
              </div>
            </div>
          </el-row>
          <el-row style="width: 100%; height: 85%">
            <!--  雷达图 -->
            <div style="width: 50%;">
              <WorkOrder style="margin-top: -40px" ref="workorder"></WorkOrder>
            </div>
            <!-- 轮播图 -->
            <div style="width: 50%">
    ...
    <el-row class="row-2 card-bottom card-with-title card-1" :gutter="15" style="width: 100%">
      ...
      <el-row style="width: 100%">
        ...
        <div style="width: 50%; height: 250px">
          <Resource ref="resource" style="height: 256px"></Resource>
        </div>
      </el-row>
    </el-row>
  </div>
...
<script>
  ...
  // import PullOutTest from "@/components/qualityservice/PullOutTest";
  ...
  import Carousel from "@/components/emergency/Carousel";
  import WorkOrder from "@/components/emergency/WorkOrder";
  import RingChart from "@/components/common/RingChart";
  ...
  export default {
    ...
    setup() {
      ...
      // const resChange = () => {
      //   const data = {
      //     jsonFile: "speSupport-resVisual-resView-res-select.json",
      //     desc: "支撑专题-资源可视化",
      //     spe: "5g",
      //   };
      //   $axios
      ...
      onMounted(() => {
        ...
        // processVis.value.setTitle("工单数分省排名");
        // resource.value.setTitle("工单数进30日趋势");
        // resource.value.setValues({
        //   name: "客户数",
        //   data: [55, 59, 69, 59, 44, 33, 72],
