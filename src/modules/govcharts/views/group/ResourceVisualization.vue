    ...
    <el-row class="row-1" :gutter="15">
      <el-col :span="14">
        <div class="card-left card-4-angle">
          ...
          <div class="button-img">
            <img src="../../../../assets/resource/Card-Heading-Control.png" alt="">
          </div>
          <div class="map-top">
            <el-row :gutter="12">
      ...
      <el-col :span="10">
        ...
        <div style="margin-bottom: 15px;">
          <img src="../../../../assets/resource/group1.png" style="margin: -6px;" alt="">
        </div>
        <div style="margin-bottom: 15px;">
          <img src="../../../../assets/resource/group2.png" style="margin: -6px;" alt="">
        </div>
        <div>
          <img src="../../../../assets/resource/group3.png" style="margin: -6px; height: 215px; width: 100%;" alt="">
        </div>
...
<script>
  ...
  import MapLines from '@/components/topicsupport/MapLines.vue';
  ...
  export default {
    components: {
      MapLines, MapTopCard, RingChart, MapHeader, WarnRanking, LineChart, SearchInfo, Warn, TableDialog, QueryCondition
    },
    setup() {
