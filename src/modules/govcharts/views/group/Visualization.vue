    ...
    <el-row class="row-1" :gutter="15">
      <el-col :span="14">
        <div class="card-left card-4-angle">
          ...
          <MapLines ref="mapChart" :data="mapData" curCard="在线用户数" @handleMapChange="handleMapChange"
            @handleMapSelect="handleMapSelect"></MapLines>
        </div>
      </el-col>
      <el-col :span="10">
            ...
            <div class="float-title-right">
              <div class="case-distribution-line">
                ...
                <div class="case-distribution-two">
                  <p style="margin-top: 4px">投诉工单</p>
                </div>
                <div class="case-distribution-five">
                  <p style="margin-top: -30px;margin-left: -30px;">网络制式</p>
                </div>
                <div class="case-distribution-three">
                  <p style="margin-top: 4px">集团</p>
                </div>
                <div class="case-distribution-fore">
                  <p style="margin-top: -5px">省内</p>
                </div>
              </div>
            </div>
          </el-row>
...
<script>
  ...
  import MapLines from "@/components/topicsupport/MapLines";
