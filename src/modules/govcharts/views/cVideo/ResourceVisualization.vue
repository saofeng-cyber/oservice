    ...
    <el-row class="row-1" :gutter="15">
      <el-col :span="14">
        <div class="card-left card-4-angle">
          ...
          <div class="map-top">
            <el-row :gutter="12">
              <el-col :span="8" v-for="(item, index) in mapTopCardList" :key="index">
      ...
      <el-col :span="10">
        ...
        <div style="margin-bottom: 15px;">
          <img src="../../../../assets/resource/sCamera1.png" style="margin: -6px;" alt="">
        </div>
        <div style="margin-bottom: 15px;">
          <img src="../../../../assets/resource/cVideo2.png" style="margin: -6px;" alt="">
        </div>
        <div>
          <img src="../../../../assets/resource/cVideo3.png" style="margin: -6px; width: 100%; height: 195px;" alt="">
        </div>
